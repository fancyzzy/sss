...
if sys.platform == 'win32':
    os.environ['TKDND_LIBRARY'] = os.path.join(os.getcwd(),'tkdnd2.8')
else:
    print ("System is not 'win32':",sys.platform)
    os.environ['TKDND_LIBRARY'] = os.path.join(os.getcwd(),'tkdnd_mac2.8')
